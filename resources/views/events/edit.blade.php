...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Chỉnh Sửa Sự Kiện</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Biểu Mẫu Chỉnh Sửa Sự Kiện</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-control @error('event_type') is-invalid @enderror" 
                            ...
                            <option value="Hội Thảo" {{ old('event_type', $event->event_type) == 'Hội Thảo' ? 'selected' : '' }}>Hội Thảo</option>
                            <option value="Gặp Gỡ Tác Giả" {{ old('event_type', $event->event_type) == 'Gặp Gỡ Tác Giả' ? 'selected' : '' }}>Gặp Gỡ Tác Giả</option>
                            <option value="Câu Lạc Bộ Đọc Sách" {{ old('event_type', $event->event_type) == 'Câu Lạc Bộ Đọc Sách' ? 'selected' : '' }}>Câu Lạc Bộ Đọc Sách</option>
                            <option value="Triển Lãm" {{ old('event_type', $event->event_type) == 'Triển Lãm' ? 'selected' : '' }}>Triển Lãm</option>
                            <option value="Khác" {{ old('event_type', $event->event_type) == 'Khác' ? 'selected' : '' }}>Khác</option>
                        </select>
                        @error('event_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
